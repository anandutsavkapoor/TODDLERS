...
from generate_line_profiles import LineProfileGenerator
...
if __name__ == "__main__":
    # Replace with your actual Cloudy output directory
    cloudy_dir = "/Users/akapoor/toddlers_evolution_package/cloudy_output/template_SB99/imf_kroupa100/star_type_sin/cluster_mode_burst/profile_type_modified_bonnor_ebert/Z0.003_eta0.05_n100.0_logM6.00/"
    
    # Test shell model at 0.1 Myr
    test_sed_resolution(cloudy_dir, time=0.85, model='unified')