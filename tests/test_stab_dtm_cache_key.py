...
def _cache_path(tmp_path, dtm):
    ...
    dm.generator = types.SimpleNamespace(f_dust=dtm)
...
def test_dtm_suffix_format_and_baseline(tmp_path):
    ...
    assert _cache_path(tmp_path, 0.20).name == "Z0.008_eta0.05_n80.0_logM6.25_fdust0.2.pkl"
    assert _cache_path(tmp_path, 0.001).name == "Z0.008_eta0.05_n80.0_logM6.25_fdust0.001.pkl"
